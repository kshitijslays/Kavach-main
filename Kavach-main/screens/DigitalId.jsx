...
const styles = StyleSheet.create({
  ...
  walletPass: {
    ...
    borderRadius: 24,
    backgroundColor: "#fff",
    boxShadow: [{ color: "rgba(15, 23, 42, 0.1)", offsetX: 0, offsetY: 16, blurRadius: 32 }],
    elevation: 12,
    marginBottom: 32,
    overflow: 'hidden',
    borderWidth: 1,
  ...
  qrContainer: {
    ...
    backgroundColor: "#fff",
    borderRadius: 20,
    boxShadow: [{ color: "rgba(0, 0, 0, 0.08)", offsetX: 0, offsetY: 4, blurRadius: 12 }],
    elevation: 4,
    marginBottom: 16,
    borderWidth: 1,
    borderColor: "#F1F5F9",
  ...
  primaryButton: {
    ...
    paddingVertical: 16,
    borderRadius: 16,
    boxShadow: [{ color: "rgba(15, 23, 42, 0.2)", offsetX: 0, offsetY: 6, blurRadius: 10 }],
    elevation: 6,
  },
  primaryButtonText: {
    color: "#fff",
